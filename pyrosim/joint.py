...
class JOINT: 
    ...
    def __init__(self,name,parent,child,type,position,axis,lower,upper):
    ...
    def Save(self,f):
        ...
        Save_Whitespace(self.depth,f)
        originString = str(self.axis[0]) + " " + str(self.axis[1]) + " " + str(self.axis[2])
        f.write('   <axis xyz="' + originString + '"/>\n')
